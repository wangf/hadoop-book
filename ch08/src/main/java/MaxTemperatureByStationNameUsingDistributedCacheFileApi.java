...
public class MaxTemperatureByStationNameUsingDistributedCacheFileApi extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.addCacheFile(new File("../input/ncdc/metadata/stations-fixed-width.txt").toURI());
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new MaxTemperatureByStationNameUsingDistributedCacheFileApi(), args);
